        ...
        <div className="container">
            <div className="row p-5 mt-5 text-center border-top">
                <div className="col-8 p-4">
                      ...
                      <ul style={{textAlign:"left", lineHeight:"2.5", fontSize:".7rem" }} className="text-muted">
                        <li>
                        ...
                        <li>
                            If account is in debit balance, any order placed will be charged ₹40 per executed order instead of 
